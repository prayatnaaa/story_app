...
import com.prayatna.storyapp.data.local.paging.StoryRemoteMediator
...
//    }
    ...
    suspend fun addStory(image: File, description: String, lat: Float, long: Float): Result<AddResponse> {
        return try {
            ...
            val response = apiService.addStory(multipartBody, descRequestBody, latRequestBody, longRequestBody, "Bearer ${token()}")
